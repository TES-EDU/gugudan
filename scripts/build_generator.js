...
const output = `import { ProblemTag, ProblemCategory, Operator, GradeId } from './types';
...
fs.writeFileSync(path.join(process.cwd(), 'src/game/curriculumProblemGenerator.ts'), output);
console.log('src/game/curriculumProblemGenerator.ts generated');
